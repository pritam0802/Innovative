...
<%@page import="com.innovative.InnovWeb.common.SyscodeConstants"%>
<%@page import="com.innovative.InnovWeb.dto.AppUser"%>
<%@page import="com.innovative.InnovWeb.common.SessionConstants"%>
<%@page import="com.innovative.InnovWeb.common.SessionManager"%>
<%

AppUser user= (AppUser) SessionManager.getInstance(request)
.getSessionAttribute(
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown" dropdown>
            <a href class="dropdown-toggle clear" dropdown-toggle>
              ...
              <span class="hidden-sm hidden-md">Hi, <%=name%></span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
            <ul class="dropdown-menu animated fadeInRight w">
